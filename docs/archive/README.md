...
Status: Archive  
Audience: maintainers and future editors  
Classification: Public-safe historical material

This folder keeps older drafts, planning notes, and superseded technical
writeups that are still useful as project history but should not crowd the
current public documentation surface.
...
| `legacy-traces-and-anomaly-monitoring.md` | Earlier trace/anomaly walkthrough superseded by the curated observability guides. |
| `legacy-unified-observability-capabilities.md` | Early capability notes replaced by the current public docs catalog and README positioning. |
| `legacy-zk-snark-observability-integrity.md` | Older article draft about observability and integrity, retained for future rewrite into a polished public proof story. |
