...
#   GOALERT_ADMIN_PASS       - Admin password (default: REDACTED)
#   GOALERT_CARLOS_PASS      - Carlos password (default: REDACTED)
...
GOALERT_ADMIN_PASS="${GOALERT_ADMIN_PASS:-REDACTED}"
GOALERT_CARLOS_PASS="${GOALERT_CARLOS_PASS:-REDACTED}"
